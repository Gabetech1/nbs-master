...
name:user
  ...
  constructor(private api: ApiService, private router: Router, private route:ActivatedRoute) {
    ...
    this.api.getrackById(id).subscribe(res => {
      console.log(res)
      this.trackid =res['id']
  ...
  update(form){
    ...
    console.log(data)
    this.api.updateTrackById(data).subscribe(res => {
      console.log(res)
      this.api.showAlert('success','Tracking Details has been updated successfully')
      ...
      if(err.error.text == "inserted successfully"){
        ...
        this.api.showAlert('failed','Check your internet connection and try again')
      }
